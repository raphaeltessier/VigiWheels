...
class Metaclass_JoystickOrder(type):
    ...
    @property
    def RECORD_PATH__DEFAULT(cls):
        """Return default value for message field 'record_path'."""
        return False
...
class JoystickOrder(metaclass=Metaclass_JoystickOrder):
    ...
    def __init__(self, **kwargs):
        ...
        self.record_path = kwargs.get(
            'record_path', JoystickOrder.RECORD_PATH__DEFAULT)
    ...
    def __eq__(self, other):
        ...
        if self.mode != other.mode:
            return False
        if self.record_path != other.record_path:
            return False
    ...
    def record_path(self, value):
        if __debug__:
            assert \
                isinstance(value, bool), \
                "The 'record_path' field must be of type 'bool'"
