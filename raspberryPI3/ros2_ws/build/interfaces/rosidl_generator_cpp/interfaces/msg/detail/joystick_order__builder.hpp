...
class Init_JoystickOrder_record_path
{
public:
  explicit Init_JoystickOrder_record_path(::interfaces::msg::JoystickOrder & msg)
  : msg_(msg)
  {}
  Init_JoystickOrder_throttle record_path(::interfaces::msg::JoystickOrder::_record_path_type arg)
  {
...
public:
  ...
  : msg_(msg)
  {}
  Init_JoystickOrder_record_path mode(::interfaces::msg::JoystickOrder::_mode_type arg)
  {
    msg_.mode = std::move(arg);
    return Init_JoystickOrder_record_path(msg_);
  }
