...
#include "rosbridge_test_msgs/action/detail/test_empty__rosidl_typesupport_fastrtps_cpp.hpp"
...
static size_t _TestEmpty_Goal__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_TestEmpty_Goal(full_bounded, is_plain, 0);
...
static size_t _TestEmpty_Result__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_TestEmpty_Result(full_bounded, is_plain, 0);
...
static size_t _TestEmpty_Feedback__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_TestEmpty_Feedback(full_bounded, is_plain, 0);
...
// functions for rosbridge_test_msgs::action::TestEmpty_Goal already declared above
...
static size_t _TestEmpty_SendGoal_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_TestEmpty_SendGoal_Request(full_bounded, is_plain, 0);
...
static size_t _TestEmpty_SendGoal_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_TestEmpty_SendGoal_Response(full_bounded, is_plain, 0);
...
static size_t _TestEmpty_GetResult_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_TestEmpty_GetResult_Request(full_bounded, is_plain, 0);
...
// forward declaration of message dependencies and their conversion functions
// functions for rosbridge_test_msgs::action::TestEmpty_Result already declared above
...
static size_t _TestEmpty_GetResult_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_TestEmpty_GetResult_Response(full_bounded, is_plain, 0);
...
// functions for rosbridge_test_msgs::action::TestEmpty_Feedback already declared above
...
static size_t _TestEmpty_FeedbackMessage__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_TestEmpty_FeedbackMessage(full_bounded, is_plain, 0);
