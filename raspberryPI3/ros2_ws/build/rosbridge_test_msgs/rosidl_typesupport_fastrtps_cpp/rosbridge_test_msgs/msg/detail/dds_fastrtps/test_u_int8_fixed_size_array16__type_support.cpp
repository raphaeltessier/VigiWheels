...
{
  auto typed_message =
    static_cast<const rosbridge_test_msgs::msg::TestUInt8FixedSizeArray16 *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<rosbridge_test_msgs::msg::TestUInt8FixedSizeArray16 *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _TestUInt8FixedSizeArray16__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const rosbridge_test_msgs::msg::TestUInt8FixedSizeArray16 *>(
...
static rosidl_message_type_support_t _TestUInt8FixedSizeArray16__handle = {
...
{
  return &rosbridge_test_msgs::msg::typesupport_fastrtps_cpp::_TestUInt8FixedSizeArray16__handle;
}
