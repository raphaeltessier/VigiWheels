...
#include "rosbridge_test_msgs/srv/detail/add_two_ints__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const rosbridge_test_msgs::srv::AddTwoInts_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<rosbridge_test_msgs::srv::AddTwoInts_Request *>(
    untyped_ros_message);
...
{
  return &rosbridge_test_msgs::srv::typesupport_fastrtps_cpp::_AddTwoInts_Request__handle;
}
...
{
  auto typed_message =
    static_cast<const rosbridge_test_msgs::srv::AddTwoInts_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<rosbridge_test_msgs::srv::AddTwoInts_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &rosbridge_test_msgs::srv::typesupport_fastrtps_cpp::_AddTwoInts_Response__handle;
}
...
{
  return &rosbridge_test_msgs::srv::typesupport_fastrtps_cpp::_AddTwoInts__handle;
}
