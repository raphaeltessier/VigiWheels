...
#include "rosbridge_test_msgs/msg/detail/num__rosidl_typesupport_fastrtps_c.h"
...
using _Num__ros_msg_type = rosbridge_test_msgs__msg__Num;
...
static uint32_t _Num__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_rosbridge_test_msgs__msg__Num(
...
static size_t _Num__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_rosbridge_test_msgs__msg__Num(
