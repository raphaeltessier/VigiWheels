...
static size_t _TestRequestOnly_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_rosbridge_test_msgs__srv__TestRequestOnly_Request(
...
static size_t _TestRequestOnly_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_rosbridge_test_msgs__srv__TestRequestOnly_Response(
    full_bounded, is_plain, 0);
