...
class Init_CamPosOrder_cam_angle
{
public:
  explicit Init_CamPosOrder_cam_angle(::interfaces::msg::CamPosOrder & msg)
  : msg_(msg)
  {}
  ::interfaces::msg::CamPosOrder cam_angle(::interfaces::msg::CamPosOrder::_cam_angle_type arg)
  {
...
public:
  ...
  {}
  Init_CamPosOrder_cam_angle mode(::interfaces::msg::CamPosOrder::_mode_type arg)
  {
    msg_.mode = std::move(arg);
    return Init_CamPosOrder_cam_angle(msg_);
  }
