...
#include "interfaces/msg/detail/gnss__rosidl_typesupport_fastrtps_c.h"
...
using _Gnss__ros_msg_type = interfaces__msg__Gnss;
...
size_t get_serialized_size_interfaces__msg__Gnss(
  const void * untyped_ros_message,
...
static uint32_t _Gnss__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_interfaces__msg__Gnss(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_interfaces
size_t max_serialized_size_interfaces__msg__Gnss(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = interfaces__msg__Gnss;
    is_plain =
      (
...
static size_t _Gnss__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_interfaces__msg__Gnss(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, interfaces, msg, Gnss)() {
