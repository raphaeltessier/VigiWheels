...
#include "interfaces/msg/detail/gnss__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const interfaces::msg::Gnss & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  interfaces::msg::Gnss & ros_message)
{
  // Member: latitude
  cdr >> ros_message.latitude;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = interfaces::msg::Gnss;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const interfaces::msg::Gnss *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<interfaces::msg::Gnss *>(
    untyped_ros_message);
...
{
  return &interfaces::msg::typesupport_fastrtps_cpp::_Gnss__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, interfaces, msg, Gnss)() {
  return &interfaces::msg::typesupport_fastrtps_cpp::_Gnss__handle;
}
